...
# Title: Punto5
# Author: Kevin_Rueda_Dana_Cotes_B1B_G2
...
class lab1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._samp_rate_win = RangeWidget(self._samp_rate_range, self.set_samp_rate, "freq de muestreo", "counter_slider", float, QtCore.Qt.Horizontal)
